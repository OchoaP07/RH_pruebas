...
def candidato_fdetalle(vac):
    ...
    dato13 = cursor.fetchall()
    cursor.execute('select edad from candidato where idCandidato = %s', (vac))
    dato14 = cursor.fetchall()
    cursor.execute('select sexo from candidato where idCandidato = %s', (vac))
    dato15 = cursor.fetchall()
    cursor.execute('select idEstadoCivil from candidato where idCandidato = %s', (vac))
    dato16 = cursor.fetchall()
    cursor.execute('select idGradoAvance from candidato where idCandidato = %s', (vac))
    dato17 = cursor.fetchall()
    cursor.execute('select idCarrera from candidato where idCandidato = %s', (vac))
    dato18 = cursor.fetchall()
    cursor.execute('select entrevSelecReq from candidato where idCandidato = %s', (vac))
    dato19 = cursor.fetchall()
    cursor.execute('select entrevSelecPresen from candidato where idCandidato = %s', (vac))
    dato20 = cursor.fetchall()
    cursor.execute('select entrevSelecResult from candidato where idCandidato = %s', (vac))
    dato21 = cursor.fetchall()
    cursor.execute('select evalPsicolgReq from candidato where idCandidato = %s', (vac))
    dato22 = cursor.fetchall()
    cursor.execute('select evalPsicologPresen from candidato where idCandidato = %s', (vac))
    dato23 = cursor.fetchall()
    cursor.execute('select evalPsicologResul from candidato where idCandidato = %s', (vac))
    dato24 = cursor.fetchall()
    cursor.execute('select evalMedicalReq from candidato where idCandidato = %s', (vac))
    dato25 = cursor.fetchall()
    cursor.execute('select evalMedicalPresen from candidato where idCandidato = %s', (vac))
    dato26 = cursor.fetchall()
    cursor.execute('select evalMedicalResult from candidato where idCandidato = %s', (vac))
    dato27 = cursor.fetchall()
    cursor.execute('select evalPsicometReq from candidato where idCandidato = %s', (vac))
    dato28 = cursor.fetchall()
    cursor.execute('select evalPsicometPresen from candidato where idCandidato = %s', (vac))
    dato29 = cursor.fetchall()
    cursor.execute('select evalPsicometResult from candidato where idCandidato = %s', (vac))
    dato30 = cursor.fetchall()
    cursor.execute('select evalTecnicaReq from candidato where idCandidato = %s', (vac))
    dato31 = cursor.fetchall()
    cursor.execute('select evalTecnicaPresent from candidato where idCandidato = %s', (vac))
    dato32 = cursor.fetchall()
    cursor.execute('select evalTecnicalResult from candidato where idCandidato = %s', (vac))
    dato33 = cursor.fetchall()
    cursor.execute('select evalConocReq from candidato where idCandidato = %s', (vac))
    dato34 = cursor.fetchall()
    cursor.execute('select evalConocPresent from candidato where idCandidato = %s', (vac))
    dato35 = cursor.fetchall()
    cursor.execute('select evalConocResult from candidato where idCandidato = %s', (vac))
    dato36 = cursor.fetchall()
    cursor.execute('select evalFinalReq from candidato where idCandidato = %s', (vac))
    dato37 = cursor.fetchall()
    cursor.execute('select evalFinalPresen from candidato where idCandidato = %s', (vac))
    dato38 = cursor.fetchall()
    cursor.execute('select evalFinalResult from candidato where idCandidato = %s', (vac))
    dato39 = cursor.fetchall()
